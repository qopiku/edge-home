async function extension_init() {
    try {
        /* Color List of Tailwind CSS */
        ...
        /* End Link Text Colors */

        /* Start Selector Declaration */
        ...
        const loadLinks = async () => {
            ...
            for (const link of favorites) {
                ...
                let url = link.url;
                let color = linkTextColors[
                    Object.keys(linkTextColors)[
                    Object.keys(linkTextColors).length * Math.random() << 0
                    ]
                ];
        ...
        /* Start Icons */
        const sunIcon = await fileGetContents("./homepage/img/uil_sun.svg");
        const moonIcon = await fileGetContents("./homepage/img/uil_moon.svg");
        /* End Icons */

        /* Initiation within Initiation? */
        loadTime();
...
document.addEventListener("DOMContentLoaded", extension_init);